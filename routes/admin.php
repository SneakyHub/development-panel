...
/*
|--------------------------------------------------------------------------
| PteroX Admin Controller Routes
|--------------------------------------------------------------------------
|
| Endpoint: /admin/pterox
|
*/
Route::group(['prefix' => 'pterox'], function () {
    Route::get('/', [Admin\PteroX\IndexController::class, 'index'])->name('admin.pterox.index');
    
    Route::group(['prefix' => 'config'], function () {
        Route::get('/', [Admin\PteroX\ConfigController::class, 'index'])->name('admin.pterox.config.index');
        Route::post('/post', [Admin\PteroX\ConfigController::class, 'post'])->name('admin.pterox.config.post');
    });
});
