...
const VariableBox = ({ variable }: Props) => {
    ...
    return (
        <TitledGreyBox
            title={
                <p css={tw`text-sm font-semibold text-[color:var(--ptx-text)] uppercase`}>
                    {!variable.isEditable && (
        ...
        >
            ...
            <InputSpinner visible={loading} css={tw`mb-2 md:mb-4`}>
                {useSwitch ? (
                    <>
                        <Switch
                        ...
                        {selectValues.length > 0 ? (
                            ...
                            <>
                                <Input
                                    ...
                                    css={tw`font-semibold text-[color:var(--ptx-text)]`}
                                    readOnly={!canEdit || !variable.isEditable}
                                    name={variable.envVariable}
                                    defaultValue={variable.serverValue}
