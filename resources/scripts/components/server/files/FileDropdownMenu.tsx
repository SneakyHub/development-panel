...
const StyledRow = styled.div<{ $danger?: boolean }>`
    ${tw`p-2 flex items-center rounded font-semibold text-[color:var(--ptx-text)]`};
    ${(props) =>
        props.$danger ? tw`hover:text-red-700  border-[color:var(--ptx-border)] hover:border hover:bg-[color:var(--ptx-secondary)]` : tw`hover:bg-[color:var(--ptx-secondary)] border-[color:var(--ptx-border)] hover:border`};
`;
