...
const FileObjectRow = ({ file }: { file: FileObject }) => (
    ...
    >
        ...
        <Clickable file={file}>
            <div css={tw`flex-none text-[color:var(--ptx-text)] font-semibold ml-6 mr-4 text-lg pl-3`}>
                {file.isFile ? (
                    <FontAwesomeIcon
            ...
            <div css={tw`flex-1 truncate text-[color:var(--ptx-text)] font-semibold text-sm`}>{file.name}</div>
