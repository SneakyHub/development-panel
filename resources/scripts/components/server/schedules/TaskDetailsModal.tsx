                ...
                <Form css={tw`m-0`}>
                    ...
                    <div css={tw`flex`}>
                        <div css={tw`mr-2 w-1/3`}>
                            <Label>Action</Label>
                            <ActionListener />
                            <FormikFieldWrapper name={'action'} className="bg-[color:var(--ptx-primary)]">
                                <FormikField as={Select} name={'action'}>
                                    <option value={'command'} className="bg-[color:var(--ptx-primary)]">Send command</option>
                                    <option value={'power'} className="bg-[color:var(--ptx-primary)]">Send power action</option>
                                    <option value={'backup'} className="bg-[color:var(--ptx-primary)]">Create backup</option>
                                </FormikField>
                            </FormikFieldWrapper>
                        </div>
                    ...
                    <div css={tw`mt-6`}>
                        {values.action === 'command' ? (
                            ...
                            <div>
                                <Label>Payload</Label>
                                <FormikFieldWrapper name={'payload'} className="bg-[color:var(--ptx-primary)]">
                                    <FormikField as={Select} name={'payload'}>
                                        <option value={'start'} className="bg-[color:var(--ptx-primary)]">Start the server</option>
                                        <option value={'restart'} className="bg-[color:var(--ptx-primary)]">Restart the server</option>
                                        <option value={'stop'} className="bg-[color:var(--ptx-primary)]">Stop the server</option>
                                        <option value={'kill'} className="bg-[color:var(--ptx-primary)]">Terminate the server</option>
                                    </FormikField>
                                </FormikFieldWrapper>
                            </div>
                        ) : (
