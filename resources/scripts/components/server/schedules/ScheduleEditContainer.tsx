...
const CronBox = ({ title, value }: { title: string; value: string }) => (
    <div css={tw`bg-[color:var(--ptx-secondary)] rounded p-3`}>
        <p css={tw`text-[color:var(--ptx-text)] text-sm`}>{title}</p>
        <p css={tw`text-xl font-medium text-[color:var(--ptx-secondarytext)]`}>{value}</p>
    </div>
);
    ...
    return (
        <PageContentBlock title={'Schedules'}>
            ...
            {!schedule || isLoading ? (
                ...
                <>
                    <ScheduleCronRow cron={schedule.cron} css={tw`sm:hidden bg-[color:var(--ptx-secondary)] rounded mb-4 p-3`} />
                    <div css={tw`rounded shadow`}>
                        <div
                            css={tw`sm:flex items-center bg-[color:var(--ptx-secondary)] p-3 sm:p-6 border-b-4 border-neutral-600 rounded-t`}
                        >
                            <div css={tw`flex-1`}>
                                <h3 css={tw`flex items-center text-neutral-100 text-2xl`}>
                                    ...
                                    {schedule.isProcessing ? (
                                        <span
                                            css={tw`flex items-center rounded-full px-2 py-px text-xs ml-4 uppercase bg-[color:var(--ptx-secondary)] text-white`}
                                        >
                        ...
                        <div css={tw`bg-[color:var(--ptx-secondary)] rounded-b`}>
