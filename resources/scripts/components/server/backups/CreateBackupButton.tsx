    ...
    return (
        <Modal {...props} showSpinnerOverlay={isSubmitting}>
            <Form>
                ...
                <h2 css={tw`text-2xl mb-6 font-bold text-[color:var(--ptx-text)]`}>Create server backup</h2>
                <Field
                    name={'name'}
                    label={'Backup name'}
                ...
                <Can action={'backup.delete'}>
                    <div css={tw`mt-6 shadow-inner p-4 rounded`}>
                        <FormikSwitch
                            name={'isLocked'}
                            label={'Locked'}
...
`;
    ...
    return (
        <>
            ...
            <Backupbtn>
            <Button css={tw`w-full sm:w-auto`} onClick={() => setVisible(true)} className="uploadbtn">
                Create backup
            </Button>
            </Backupbtn>
        </>
