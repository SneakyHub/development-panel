        ...
        <SideBar>
            ...
            <MenuBar2  css={ sidebar ? tw`w-72 p-6` : tw`w-[104px] p-6`} className=" sideBar h-screen flex flex-col items-stretch fixed w-full md:w-64 nav-primary z-40">
                <div className="topdiv">
                    ...
                    <div>
                        <div className="buttonslist">
                            <span className="serverspan" css={ sidebar ? tw`flex` : tw`hidden`}>Server Management</span>
                            <span className="serverspan" css={ sidebar ? tw`hidden` : tw`flex`}>Server</span>
                                <div>
                                {routes.server
                                    ...
                                    .map((route) =>
                                        route.permission ? (
                                            <Can key={route.path} action={route.permission} matchAny>
                                                <NavLink to={to(route.path, true)} exact={route.exact} className="buttondiv"  activeClassName="active">
                                                        <span className="spandiv">
                                                        <span className="spanicon">
                                            ...
                                            <NavLink key={route.path} to={to(route.path, true)} exact={route.exact} className="buttondiv"  activeClassName="active">
                                                <span className="spandiv">
                                                        <span className="spanicon">
                                                        <RouteIcon route={route} />
                                                        </span>
                    ...
                    {rootAdmin &&
                    <NavLink className="buttondiv"  activeClassName="admin" to={`/admin/servers/view/${serverId}`} target="_blank">
                            <span className="spandiv">
                                <span className="spanicon">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="" height="28px" width="28px">
                ...
                <div className="bottomdiv">
                    <span className="serverspan" css={ sidebar ? tw`flex` : tw`hidden`}>Account Management</span>
                    <span className="serverspan" css={ sidebar ? tw`hidden` : tw`flex`}>Acco</span>
